...
config/pi-auto-afk  optional "observe" arming the default-off, observe-only Pi idle detector, which reports an idle period and a countdown and enters no away posture; LOCAL, gitignored, and not inherited; see docs/configuration.md "Pi idle observer"
